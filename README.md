...
**[Sep. 2026]** We add an [IQSimulator](https://github.com/wwhenxuan/S2Generator/blob/main/s2generator/simulator/iq_simulator.py) for generating complex baseband / analytic IQ channel traces: the phase is taken from a real time series (or ARMA excitation), while the two-sided Doppler spectrum is matched to packaged [DeepMIMO](https://github.com/DeepMIMO/DeepMIMO) CSI. See the [IQ notebook](https://github.com/wwhenxuan/S2Generator/blob/main/examples/simulator/iq_simulator.ipynb) and the [DeepMIMO data notebook](https://github.com/wwhenxuan/S2Generator/blob/main/examples/tools/deepmimo_iq_data.ipynb).
